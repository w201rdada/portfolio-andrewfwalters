...
By looking at all traffic passing through an enterprise network, some content could be flagged as potentially malicious and stopped before it touches a vulnerable system. Consider what a computer virus might look like. A virus will contain either source code or compiled code, it will target a handful of parts of the system, and it will attempt to spread itself. Those are clear patterns that could be learned by a model trained on a large set of malware.
