...
For example, it will be easy to look at a particular educational method, such as giving students chromebooks during lectures, and show that education method being correlated to improving grades or test scores. But the desired result is improved student outcome requires following the student through their education. By identifying the important signals that predict a successful outcome for a student, research can produce better policy that improcves education in the US.

## An end.

Implementing this will be challenging on a legislative and social level. Motivating legislatures to pass action to collect this dataset will be very difficult. Another issue will be privacy, since individuals will be reluctant to trust the government to maintain this dataset. But this is a legislative priority worth pursing becuase the value to society is to great to allow poor educational policy to hold back out students.
