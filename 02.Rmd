...
While it would seem that collecting a US-wide educational dataset would be the monumental challenge, the second action is just as difficult. We need to produce great research from this data, that can guide policy at the local, state and federal level to improve educational outcomes. The challenge is that while this dataset will allow us to answer some questions easily, but the questions worth knowing the answer will still be difficult. 

For example, it will be easy to look at a particular educational method and using , say giving students chromebooks during lectures, is improving grades or test scores. Why not? Because improving grades is not the purpose of our educational system.
